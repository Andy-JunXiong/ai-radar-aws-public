...
const cases = [
  ...
  {
    name: "signal detail explains Start Project Watch without changing signal state",
    pathname: "/signals/detail?id=sig-watch",
    pageText: `${signalDetailGateText}\nStart Project Watch\nProject Watch`,
    question: "What does Start Project Watch do?",
    language: "en",
    mustInclude: ["evidence follow-up", "without changing Signal status or verification level", "watch_only", "review context only"],
    mustNotInclude: ["creates a Project Takeaway candidate", "unlocks Action"],
  },
  {
    name: "project review explains Add Observation as review context only",
    pathname: "/workspace/projects/review?view=watch",
    pageText: `${projectReviewInboxText}\nProject Watch Attention\nAdd Observation\nResolve Watch`,
    question: "What does Add Observation do?",
    language: "en",
    mustInclude: ["review_context_only", "cannot change verification_status", "blocked_downstream_actions"],
    mustNotInclude: ["verified evidence", "Action is allowed"],
  },
  {
  ...
  },
  {
    ...
    pathname: "/workspace/projects/review?view=watch",
    pageText: `${projectReviewInboxText}\nProject Watch Attention\nAdd Observation\nResolve Watch`,
    question: "What does Resolve Watch mean?",
    language: "en",
    mustInclude: ["only stops observation", "does not verify or disprove", "reviewer self-attestation"],
    mustNotInclude: ["Action is allowed", "verified claim"],
  },
